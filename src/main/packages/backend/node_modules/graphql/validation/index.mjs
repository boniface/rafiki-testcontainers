...
export { specifiedRules, recommendedRules } from 'graphql/validation/specifiedRules.mjs'; // Spec Section: "Executable Definitions"
...
export { VariablesInAllowedPositionRule } from 'graphql/validation/rules/VariablesInAllowedPositionRule.mjs';
export { MaxIntrospectionDepthRule } from 'graphql/validation/rules/MaxIntrospectionDepthRule.mjs'; // SDL-specific validation rules
