...
const { addQueryContext, normalizeArr } = require('knex/lib/util/helpers');
const JoinClause = require('knex/lib/query/joinclause');
const Analytic = require('knex/lib/query/analytic');
...
const {
  ...
  isString,
  isFunction,
} = require('knex/lib/util/is');

const { lockMode, waitMode } = require('knex/lib/query/constants');
const {
  augmentWithBuilderInterface,
} = require('knex/lib/builder-interface-augmenter');
