...
const { isFunction, isEmpty, isObject } = require('objection/lib/utils/objectUtils');
const { QueryBuilderOperation } = require('objection/lib/queryBuilder/operations/QueryBuilderOperation');
const { convertFieldExpressionsToRaw } = require('objection/lib/queryBuilder/operations/UpdateOperation');
