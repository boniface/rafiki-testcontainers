...
const { StaticHookArguments } = require('objection/lib/queryBuilder/StaticHookArguments');
const { after, mapAfterAllReturn } = require('objection/lib/utils/promiseUtils');
const { isPostgres, isSqlite, isMySql, isMsSql } = require('objection/lib/utils/knexUtils');
const { isObject } = require('objection/lib/utils/objectUtils');
