...
import resolvable from '@apollo/server/dist/cjs/utils/resolvable.js';
import { GraphQLError, assertValidSchema, print, printSchema, } from 'graphql';
import loglevel from 'loglevel';
import Negotiator from 'negotiator';
import { newCachePolicy } from '@apollo/server/dist/cjs/cachePolicy.js';
import { determineApolloConfig } from '@apollo/server/dist/cjs/determineApolloConfig.js';
import { ensureError, ensureGraphQLError, normalizeAndFormatErrors, } from '@apollo/server/dist/cjs/errorNormalize.js';
import { ApolloServerErrorCode, ApolloServerValidationErrorCode, } from '@apollo/server/errors';
import { runPotentiallyBatchedHttpQuery } from '@apollo/server/dist/cjs/httpBatching.js';
import { pluginIsInternal } from '@apollo/server/dist/cjs/internalPlugin.js';
import { preventCsrf, recommendedCsrfPreventionRequestHeaders, } from '@apollo/server/dist/cjs/preventCsrf.js';
import { APQ_CACHE_PREFIX, processGraphQLRequest } from '@apollo/server/dist/cjs/requestPipeline.js';
import { newHTTPGraphQLHead, prettyJSONStringify } from '@apollo/server/dist/cjs/runHttpQuery.js';
import { HeaderMap } from '@apollo/server/dist/cjs/utils/HeaderMap.js';
import { UnreachableCaseError } from '@apollo/server/dist/cjs/utils/UnreachableCaseError.js';
import { computeCoreSchemaHash } from '@apollo/server/dist/cjs/utils/computeCoreSchemaHash.js';
import { isDefined } from '@apollo/server/dist/cjs/utils/isDefined.js';
import { SchemaManager } from '@apollo/server/dist/cjs/utils/schemaManager.js';
    ...
    async addDefaultPlugins() {
        ...
        }
        {
            if (!alreadyHavePluginWithInternalId('CacheControl')) {
                const { ApolloServerPluginCacheControl } = await import('@apollo/server/dist/cjs/plugin/cacheControl/index.js');
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && apolloConfig.key) {
                if (apolloConfig.graphRef) {
                    const { ApolloServerPluginUsageReporting } = await import('@apollo/server/dist/cjs/plugin/usageReporting/index.js');
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && enabledViaEnvVar) {
                if (apolloConfig.key) {
                    const { ApolloServerPluginSchemaReporting } = await import('@apollo/server/dist/cjs/plugin/schemaReporting/index.js');
        ...
        }
        {
            ...
            if (!alreadyHavePlugin) {
                const { ApolloServerPluginInlineTrace } = await import('@apollo/server/dist/cjs/plugin/inlineTrace/index.js');
        ...
        if (!alreadyHavePlugin) {
            const { ApolloServerPluginLandingPageLocalDefault, ApolloServerPluginLandingPageProductionDefault, } = await import('@apollo/server/dist/cjs/plugin/landingPage/default/index.js');
            const plugin = isDev
        ...
        }
        {
            ...
            if (hideSchemaDetailsFromClientErrors && !alreadyHavePlugin) {
                const { ApolloServerPluginDisableSuggestions } = await import('@apollo/server/dist/cjs/plugin/disableSuggestions/index.js');
