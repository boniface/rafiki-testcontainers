...
const cliPkg = require('knex/package.json');
const {
  parseConfigObj,
  mkConfigObj,
...
const {
  ...
  readFile,
  writeFile,
} = require('knex/lib/migrations/util/fs');

const { listMigrations } = require('knex/bin/utils/migrationsLister');

async function openKnexfile(configPath) {
  const importFile = require('knex/lib/migrations/util/import-file'); // require me late!
