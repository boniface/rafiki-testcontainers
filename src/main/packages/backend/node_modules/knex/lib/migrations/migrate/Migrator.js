...
const {
  ...
  getTable,
  getTableName,
} = require('knex/lib/migrations/migrate/table-resolver');
const { getSchemaBuilder } = require('knex/lib/migrations/migrate/table-creator');
const migrationListResolver = require('knex/lib/migrations/migrate/migration-list-resolver');
const MigrationGenerator = require('knex/lib/migrations/migrate/MigrationGenerator');
const { getMergedConfig } = require('knex/lib/migrations/migrate/migrator-configuration-merger');
const { isBoolean, isFunction } = require('knex/lib/util/is');
