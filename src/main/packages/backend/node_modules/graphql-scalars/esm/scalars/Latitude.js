...
import { isDecimal, isSexagesimal, sexagesimalToDecimal } from 'graphql-scalars/cjs/scalars/utilities.js';
// Minimum latitude
const MIN_LAT = -90.0;
// Maximum latitude
const MAX_LAT = 90.0;
...
const validate = (value, ast) => {
    ...
    if (isDecimal(value)) {
        ...
        if (decimalValue < MIN_LAT || decimalValue > MAX_LAT) {
            throw createGraphQLError(`Value must be between ${MIN_LAT} and ${MAX_LAT}: ${value}`, ast ? { nodes: ast } : undefined);
        }
