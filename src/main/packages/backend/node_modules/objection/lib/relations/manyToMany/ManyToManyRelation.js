...
const { getModel } = require('objection/lib/model/getModel');
...
const { isSqlite } = require('objection/lib/utils/knexUtils');
const { inheritModel } = require('objection/lib/model/inheritModel');
const { resolveModel } = require('objection/lib/utils/resolveModel');
const { mapAfterAllReturn } = require('objection/lib/utils/promiseUtils');
const { isFunction, isObject, isString } = require('objection/lib/utils/objectUtils');
const { createModifier } = require('objection/lib/utils/createModifier');

const { ManyToManyFindOperation } = require('objection/lib/relations/manyToMany/find/ManyToManyFindOperation');
const { ManyToManyInsertOperation } = require('objection/lib/relations/manyToMany/insert/ManyToManyInsertOperation');
const { ManyToManyRelateOperation } = require('objection/lib/relations/manyToMany/relate/ManyToManyRelateOperation');

const { ManyToManyUnrelateOperation } = require('objection/lib/relations/manyToMany/unrelate/ManyToManyUnrelateOperation');
const {
  ManyToManyUnrelateSqliteOperation,
} = require('objection/lib/relations/manyToMany/unrelate/ManyToManyUnrelateSqliteOperation');

const { ManyToManyUpdateOperation } = require('objection/lib/relations/manyToMany/update/ManyToManyUpdateOperation');
const { ManyToManyUpdateSqliteOperation } = require('objection/lib/relations/manyToMany/update/ManyToManyUpdateSqliteOperation');

const { ManyToManyDeleteOperation } = require('objection/lib/relations/manyToMany/delete/ManyToManyDeleteOperation');
const { ManyToManyDeleteSqliteOperation } = require('objection/lib/relations/manyToMany/delete/ManyToManyDeleteSqliteOperation');
