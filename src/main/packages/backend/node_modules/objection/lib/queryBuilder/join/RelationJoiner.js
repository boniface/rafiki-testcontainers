...
const { uniqBy } = require('objection/lib/utils/objectUtils');
...
const { map: mapPromise } = require('objection/lib/utils/promiseUtils');
const { ValidationErrorType } = require('objection/lib/model/ValidationError');

const { TableTree } = require('objection/lib/queryBuilder/join/TableTree');
const { JoinResultParser } = require('objection/lib/queryBuilder/join/JoinResultParser');
const { ID_LENGTH_LIMIT } = require('objection/lib/queryBuilder/join/utils');
