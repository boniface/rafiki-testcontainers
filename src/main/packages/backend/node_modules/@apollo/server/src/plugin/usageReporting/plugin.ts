...
import { internalPlugin } from '@apollo/server/src/internalPlugin.js';
import { dateToProtoTimestamp, TraceTreeBuilder } from '@apollo/server/src/plugin/traceTreeBuilder.js';
import { defaultSendOperationsAsTrace } from '@apollo/server/src/plugin/usageReporting/defaultSendOperationsAsTrace.js';
import {
  createOperationDerivedDataCache,
  type OperationDerivedData,
  operationDerivedDataCacheKey,
} from '@apollo/server/src/plugin/usageReporting/operationDerivedDataCache.js';
import type {
  ApolloServerPluginUsageReportingOptions,
  SendValuesBaseOptions,
} from '@apollo/server/src/plugin/usageReporting/options.js';
import { OurReport } from '@apollo/server/src/plugin/usageReporting/stats.js';
import { makeTraceDetails } from '@apollo/server/src/plugin/usageReporting/traceDetails.js';
import { packageVersion } from '@apollo/server/src/generated/packageVersion.js';
import { computeCoreSchemaHash } from '@apollo/server/src/utils/computeCoreSchemaHash.js';
import type { HeaderMap } from '@apollo/server/src/utils/HeaderMap.js';
import { schemaIsSubgraph } from '@apollo/server/src/plugin/schemaIsSubgraph.js';
