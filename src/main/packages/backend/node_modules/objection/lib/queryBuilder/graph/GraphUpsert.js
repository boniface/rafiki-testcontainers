...
const { ModelGraph } = require('objection/lib/model/graph/ModelGraph');
const { ModelGraphEdge } = require('objection/lib/model/graph/ModelGraphEdge');
const { createNotModelError } = require('objection/lib/model/graph/ModelGraphBuilder');
const { GraphFetcher } = require('objection/lib/queryBuilder/graph/GraphFetcher');
const { GraphInsert } = require('objection/lib/queryBuilder/graph/insert/GraphInsert');
const { GraphPatch } = require('objection/lib/queryBuilder/graph/patch/GraphPatch');
const { GraphDelete } = require('objection/lib/queryBuilder/graph/delete/GraphDelete');
const { GraphRecursiveUpsert } = require('objection/lib/queryBuilder/graph/recursiveUpsert/GraphRecursiveUpsert');
const { GraphOptions } = require('objection/lib/queryBuilder/graph/GraphOptions');
...
const { GraphNodeDbExistence } = require('objection/lib/queryBuilder/graph/GraphNodeDbExistence');
const { GraphData } = require('objection/lib/queryBuilder/graph/GraphData');
const { uniqBy, asArray, isObject } = require('objection/lib/utils/objectUtils');
