...
const { AbstractMigrationsLoader } = require('knex/lib/migrations/common/MigrationsLoader');
const { getFilepathsInFolder } = require('knex/lib/migrations/util/fs');
...
class FsSeeds extends AbstractMigrationsLoader {
  ...
  async getSeed(filepath) {
    const importFile = require('knex/lib/migrations/util/import-file'); // late import
