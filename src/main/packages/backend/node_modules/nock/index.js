...
const back = require('nock/lib/back')
const emitter = require('nock/lib/global_emitter')
const {
  activate,
  isActive,
  isDone,
...
} = require('nock/lib/intercept')
const recorder = require('nock/lib/recorder')
const { Scope, load, loadDefs, define } = require('nock/lib/scope')
