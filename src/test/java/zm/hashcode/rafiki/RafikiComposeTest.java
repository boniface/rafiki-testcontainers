...
public class RafikiComposeTest {
    ...
    void backendContainersStartAndPortsAreAccessible() throws Exception {
        // Verify backend admin port is accessible
        ...
        // Verify backend Open Payments port
        ...
        System.out.println("ℹ️  Note: Auth and Frontend services require Kratos configuration");
    }

    @Test
    void backendAdminPortResponds() throws Exception {
        // Give services a moment to fully start after container is up
        Thread.sleep(5000);
