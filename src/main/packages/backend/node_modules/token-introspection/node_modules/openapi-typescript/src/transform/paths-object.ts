import type { GlobalContext, PathsObject, PathItemObject, ParameterObject, ReferenceObject, OperationObject } from "openapi-typescript/src/types.js";
import { escStr, getEntries, getParametersArray, getSchemaObjectComment, indent } from "openapi-typescript/src/utils.js";
