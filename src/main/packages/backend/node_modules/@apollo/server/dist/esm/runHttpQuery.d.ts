import type { BaseContext, HTTPGraphQLHead, HTTPGraphQLRequest, HTTPGraphQLResponse } from '@apollo/server/dist/esm/externalTypes';
import { type ApolloServer, type ApolloServerInternals, type SchemaDerivedData } from '@apollo/server/dist/esm/ApolloServer.js';
