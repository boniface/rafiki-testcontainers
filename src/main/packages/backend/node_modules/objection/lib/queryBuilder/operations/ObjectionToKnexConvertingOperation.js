...
const { isPlainObject, isObject, isFunction, once } = require('objection/lib/utils/objectUtils');
const { isKnexQueryBuilder, isKnexJoinBuilder } = require('objection/lib/utils/knexUtils');
const { transformation } = require('objection/lib/queryBuilder/transformations');
const getJoinBuilder = once(() => require('objection/lib/queryBuilder/JoinBuilder').JoinBuilder);
