...
let WritableStream = require('node-mocks-http/lib/mockWritableStream');
let EventEmitter = require('node-mocks-http/lib/mockEventEmitter');
const http = require('node-mocks-http/lib/node/http');
const utils = require('node-mocks-http/lib/utils');
