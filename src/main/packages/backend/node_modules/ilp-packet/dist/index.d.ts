...
import { IlpAddress, isValidIlpAddress } from 'ilp-packet/dist/utils/address';
import * as errors from 'ilp-packet/dist/errors';
export declare const Errors: typeof errors;
export { IlpAddress, isValidIlpAddress };
export { getScheme, IlpAddressScheme } from 'ilp-packet/dist/utils/address';
export { IlpErrorCode, IlpErrorCode as IlpError, BaseIlpError as IlpErrorClass } from 'ilp-packet/dist/errors';
