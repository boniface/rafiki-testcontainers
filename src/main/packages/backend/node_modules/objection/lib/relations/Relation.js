...
const { RelationFindOperation } = require('objection/lib/relations/RelationFindOperation');
const { RelationUpdateOperation } = require('objection/lib/relations/RelationUpdateOperation');
const { RelationDeleteOperation } = require('objection/lib/relations/RelationDeleteOperation');

const { resolveModel } = require('objection/lib/utils/resolveModel');
const { get, isFunction } = require('objection/lib/utils/objectUtils');
