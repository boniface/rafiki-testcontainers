import type { ComponentsObject, DiscriminatorObject, Fetch, GlobalContext, OpenAPI3, OperationObject, ParameterObject, PathItemObject, ReferenceObject, RequestBodyObject, ResponseObject, SchemaObject, Subschema } from "openapi-typescript/src/types.js";
...
import { parseRef, error, makeTSIndex, walk, isRemoteURL, isFilepath } from "openapi-typescript/src/utils.js";
