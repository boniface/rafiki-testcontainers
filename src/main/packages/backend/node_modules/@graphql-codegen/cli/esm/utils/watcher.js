...
import { executeCodegen } from '@graphql-codegen/cli/cjs/codegen.js';
import { loadContext } from '@graphql-codegen/cli/cjs/config.js';
import { lifecycleHooks } from '@graphql-codegen/cli/cjs/hooks.js';
import { access } from '@graphql-codegen/cli/cjs/utils/file-system.js';
import { debugLog } from '@graphql-codegen/cli/cjs/utils/debugging.js';
import { getLogger } from '@graphql-codegen/cli/cjs/utils/logger.js';
import { allAffirmativePatternsFromPatternSets, makeGlobalPatternSet, makeLocalPatternSet, makeShouldRebuild, } from '@graphql-codegen/cli/cjs/utils/patterns.js';
import { AbortController } from '@graphql-codegen/cli/cjs/utils/abort-controller-polyfill.js';
function log(msg) {
