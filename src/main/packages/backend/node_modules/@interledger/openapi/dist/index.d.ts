...
export { createValidatorMiddleware, OpenAPIValidatorMiddlewareError } from '@interledger/openapi/dist/middleware';
...
export declare const isHttpMethod: (o: any) => o is OpenAPIV3.HttpMethods;
