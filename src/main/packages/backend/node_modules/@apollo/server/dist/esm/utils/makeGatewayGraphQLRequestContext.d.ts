...
import type { ApolloServer, ApolloServerInternals } from '@apollo/server/dist/esm/ApolloServer';
import type { BaseContext, GraphQLRequestContextExecutionDidStart } from '@apollo/server/dist/esm/externalTypes';
