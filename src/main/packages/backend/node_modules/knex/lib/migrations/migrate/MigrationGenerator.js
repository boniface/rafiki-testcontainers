...
const { writeJsFileUsingTemplate } = require('knex/lib/migrations/util/template');
const { getMergedConfig } = require('knex/lib/migrations/migrate/migrator-configuration-merger');
const { ensureDirectoryExists } = require('knex/lib/migrations/util/fs');
const { yyyymmddhhmmss } = require('knex/lib/migrations/util/timestamp');
