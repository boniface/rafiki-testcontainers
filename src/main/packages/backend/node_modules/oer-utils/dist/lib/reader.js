...
const underflow_error_1 = require("oer-utils/dist/errors/underflow-error");
const parse_error_1 = require("oer-utils/dist/errors/parse-error");
const long_1 = __importDefault(require("long"));
const util_1 = require("oer-utils/dist/lib/util");
class Reader {
    constructor(buffer) {
        this.buffer = buffer;
        this.cursor = 0;
