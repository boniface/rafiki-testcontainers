...
const { InterceptedRequestRouter } = require('nock/lib/intercepted_request_router')
const common = require('nock/lib/common')
const { inherits } = require('util')
const http = require('http')
const { intercept: debug } = require('nock/lib/debug')
const globalEmitter = require('nock/lib/global_emitter')
const { BatchInterceptor } = require('@mswjs/interceptors')
const {
  default: nodeInterceptors,
} = require('@mswjs/interceptors/presets/node')
const { createResponse } = require('nock/lib/create_response')
...
function removeInterceptor(options) {
  ...
  const Interceptor = require('nock/lib/interceptor')
