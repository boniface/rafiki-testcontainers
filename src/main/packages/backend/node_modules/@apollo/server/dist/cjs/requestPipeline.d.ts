import type { GraphQLRequestContext, BaseContext, GraphQLResponse } from '@apollo/server/dist/cjs/externalTypes';
import type { ApolloServer, ApolloServerInternals, SchemaDerivedData } from '@apollo/server/dist/cjs/ApolloServer.js';
