...
import { BaseDeps, ResourceRequestArgs, CollectionRequestArgs, RouteDeps, UnauthenticatedResourceRequestArgs } from '@interledger/open-payments/dist/client';
import { IncomingPayment, CreateIncomingPaymentArgs, PaginationArgs, IncomingPaymentPaginationResult, PublicIncomingPayment, IncomingPaymentWithPaymentMethods } from '@interledger/open-payments/dist/types';
...
export declare const getPublicIncomingPayment: (deps: BaseDeps, args: UnauthenticatedResourceRequestArgs, validateOpenApiResponse?: ResponseValidator<PublicIncomingPayment>) => Promise<{
    receivedAmount?: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    authServer: string;
}>;
...
export declare const completeIncomingPayment: (deps: BaseDeps, args: ResourceRequestArgs, validateOpenApiResponse?: ResponseValidator<IncomingPayment>) => Promise<{
    ...
    completed: boolean;
    incomingAmount?: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    receivedAmount: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    expiresAt?: string;
    metadata?: {
        [key: string]: unknown;
