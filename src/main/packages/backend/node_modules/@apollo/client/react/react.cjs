...
require('@apollo/client/utilities/globals/index.js');
var context = require('@apollo/client/react/context/index.js');
var hooks = require('@apollo/client/react/hooks/index.js');
var parser = require('@apollo/client/react/parser/index.js');
var tslib = require('tslib');
var internal = require('@apollo/client/react/internal/index.js');
