...
export { version, versionInfo } from 'graphql/version.mjs'; // The primary entry point into fulfilling a GraphQL request.

export { graphql, graphqlSync } from 'graphql/graphql.mjs'; // Create and operate on GraphQL type definitions and schema.
...
export {
  ...
  isTypeExtensionNode,
} from 'graphql/language/index.mjs';
...
} from 'graphql/execution/index.mjs';
...
} from 'graphql/validation/index.mjs';
