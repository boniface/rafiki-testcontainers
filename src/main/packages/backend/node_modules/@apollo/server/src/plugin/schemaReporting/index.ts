...
import { SchemaReporter } from '@apollo/server/src/plugin/schemaReporting/schemaReporter.js';
import { schemaIsSubgraph } from '@apollo/server/src/plugin/schemaIsSubgraph.js';
import type { SchemaReport } from '@apollo/server/src/plugin/schemaReporting/generated/operations.js';
import type { ApolloServerPlugin } from '@apollo/server/src/externalTypes';
