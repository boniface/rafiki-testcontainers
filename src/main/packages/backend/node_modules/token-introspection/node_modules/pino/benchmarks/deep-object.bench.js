...
delete require.cache[require.resolve('../')]
const plogMinLength = require('pino')(pino.destination({ dest: '/dev/null', sync: false, minLength: 4096 }))
delete require.cache[require.resolve('../')]

const loglevel = require('pino/benchmarks/utils/wrap-log-level')(dest)

const deep = Object.assign({}, require('pino/package.json'), { level: 'info' })
