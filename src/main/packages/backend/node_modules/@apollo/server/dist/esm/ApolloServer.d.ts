...
import { type Resolvable } from '@apollo/server/dist/esm/utils/resolvable.js';
...
import type { ExecuteOperationOptions, VariableValues } from '@apollo/server/dist/esm/externalTypes/graphql.js';
import type { ApolloConfig, ApolloServerOptions, ApolloServerPlugin, BaseContext, ContextThunk, DocumentStore, GraphQLRequest, GraphQLResponse, HTTPGraphQLHead, HTTPGraphQLRequest, HTTPGraphQLResponse, LandingPage, PersistedQueryOptions } from '@apollo/server/dist/esm/externalTypes';
import type { GraphQLExperimentalIncrementalExecutionResults } from '@apollo/server/dist/esm/incrementalDeliveryPolyfill.js';
import { SchemaManager } from '@apollo/server/dist/esm/utils/schemaManager.js';
