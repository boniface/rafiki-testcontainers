...
import { type Resolvable } from '@apollo/server/dist/cjs/utils/resolvable.js';
...
import type { ExecuteOperationOptions, VariableValues } from '@apollo/server/dist/cjs/externalTypes/graphql.js';
import type { ApolloConfig, ApolloServerOptions, ApolloServerPlugin, BaseContext, ContextThunk, DocumentStore, GraphQLRequest, GraphQLResponse, HTTPGraphQLHead, HTTPGraphQLRequest, HTTPGraphQLResponse, LandingPage, PersistedQueryOptions } from '@apollo/server/dist/cjs/externalTypes';
import type { GraphQLExperimentalIncrementalExecutionResults } from '@apollo/server/dist/cjs/incrementalDeliveryPolyfill.js';
