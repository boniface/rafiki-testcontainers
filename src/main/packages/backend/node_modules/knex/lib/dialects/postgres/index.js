...
const Transaction = require('knex/lib/dialects/postgres/execution/pg-transaction');
const QueryCompiler = require('knex/lib/dialects/postgres/query/pg-querycompiler');
const QueryBuilder = require('knex/lib/dialects/postgres/query/pg-querybuilder');
const ColumnCompiler = require('knex/lib/dialects/postgres/schema/pg-columncompiler');
