import type { DiscriminatorObject, GlobalContext, ReferenceObject, SchemaObject } from "openapi-typescript/src/types.js";
import { escObjKey, escStr, getEntries, getSchemaObjectComment, indent, parseRef, tsArrayOf, tsIntersectionOf, tsOmit, tsOneOf, tsOptionalProperty, tsReadonly, tsTupleOf, tsUnionOf, tsWithRequired } from "openapi-typescript/src/utils.js";
