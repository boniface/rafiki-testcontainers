...
const Oracle_Compiler = require('knex/lib/dialects/oracle/query/oracle-querycompiler');
const ReturningHelper = require('knex/lib/dialects/oracledb/utils').ReturningHelper;
const BlobHelper = require('knex/lib/dialects/oracledb/utils').BlobHelper;
