...
import { BaseDeps, ResourceRequestArgs, CollectionRequestArgs, RouteDeps } from '@interledger/open-payments/dist/client';
import { CreateOutgoingPaymentArgs, OutgoingPayment, OutgoingPaymentPaginationResult, OutgoingPaymentWithSpentAmounts, PaginationArgs } from '@interledger/open-payments/dist/types';
...
export declare const getOutgoingPayment: (deps: BaseDeps, requestArgs: ResourceRequestArgs, validateOpenApiResponse: ResponseValidator<OutgoingPayment>) => Promise<{
    ...
    failed: boolean;
    receiver: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["receiver"];
    receiveAmount: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    debitAmount: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    sentAmount: import("@interledger/open-payments/dist/openapi/generated/resource-server-types").components["schemas"]["amount"];
    metadata?: {
        [key: string]: unknown;
    };
    createdAt: string;
