...
const { createModifier } = require('objection/lib/utils/createModifier');
const { ValidationErrorType } = require('objection/lib/model/ValidationError');
const { isObject, isString, isFunction, last, flatten } = require('objection/lib/utils/objectUtils');
const { RelationExpression, DuplicateRelationError } = require('objection/lib/queryBuilder/RelationExpression');
const { assertIdNotUndefined } = require('objection/lib/utils/assert');

const { Selection } = require('objection/lib/queryBuilder/operations/select/Selection');

const { QueryBuilderContext } = require('objection/lib/queryBuilder/QueryBuilderContext');
...
const { DeleteOperation } = require('objection/lib/queryBuilder/operations/DeleteOperation');
const { UpdateOperation } = require('objection/lib/queryBuilder/operations/UpdateOperation');
const { InsertOperation } = require('objection/lib/queryBuilder/operations/InsertOperation');
const { RelateOperation } = require('objection/lib/queryBuilder/operations/RelateOperation');
const { UnrelateOperation } = require('objection/lib/queryBuilder/operations/UnrelateOperation');

const { JoinEagerOperation } = require('objection/lib/queryBuilder/operations/eager/JoinEagerOperation');
const { NaiveEagerOperation } = require('objection/lib/queryBuilder/operations/eager/NaiveEagerOperation');
const { WhereInEagerOperation } = require('objection/lib/queryBuilder/operations/eager/WhereInEagerOperation');

const { InsertGraphAndFetchOperation } = require('objection/lib/queryBuilder/operations/InsertGraphAndFetchOperation');
const { UpsertGraphAndFetchOperation } = require('objection/lib/queryBuilder/operations/UpsertGraphAndFetchOperation');
const { InsertAndFetchOperation } = require('objection/lib/queryBuilder/operations/InsertAndFetchOperation');
const { UpdateAndFetchOperation } = require('objection/lib/queryBuilder/operations/UpdateAndFetchOperation');
const { JoinRelatedOperation } = require('objection/lib/queryBuilder/operations/JoinRelatedOperation');
const { OnBuildKnexOperation } = require('objection/lib/queryBuilder/operations/OnBuildKnexOperation');
const { InsertGraphOperation } = require('objection/lib/queryBuilder/operations/InsertGraphOperation');
const { UpsertGraphOperation } = require('objection/lib/queryBuilder/operations/UpsertGraphOperation');
const { RunBeforeOperation } = require('objection/lib/queryBuilder/operations/RunBeforeOperation');
const { RunAfterOperation } = require('objection/lib/queryBuilder/operations/RunAfterOperation');
const { FindByIdOperation } = require('objection/lib/queryBuilder/operations/FindByIdOperation');
const { FindByIdsOperation } = require('objection/lib/queryBuilder/operations/FindByIdsOperation');
const { OnBuildOperation } = require('objection/lib/queryBuilder/operations/OnBuildOperation');
const { OnErrorOperation } = require('objection/lib/queryBuilder/operations/OnErrorOperation');
const { SelectOperation } = require('objection/lib/queryBuilder/operations/select/SelectOperation');
const { EagerOperation } = require('objection/lib/queryBuilder/operations/eager/EagerOperation');
const { RangeOperation } = require('objection/lib/queryBuilder/operations/RangeOperation');
const { FirstOperation } = require('objection/lib/queryBuilder/operations/FirstOperation');
const { FromOperation } = require('objection/lib/queryBuilder/operations/FromOperation');
const { KnexOperation } = require('objection/lib/queryBuilder/operations/KnexOperation');
