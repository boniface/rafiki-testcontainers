...
const promiseUtils = require('objection/lib/utils/promiseUtils');

const { EagerOperation } = require('objection/lib/queryBuilder/operations/eager/EagerOperation');
const { isMsSql, isOracle, isSqlite } = require('objection/lib/utils/knexUtils');
const { isObject, asArray, flatten, chunk } = require('objection/lib/utils/objectUtils');
...
const { RelationDoesNotExistError } = require('objection/lib/model/RelationDoesNotExistError');
