...
const { isString, isFunction, isRegExp, mergeMaps, last } = require('objection/lib/utils/objectUtils');
const { QueryBuilderContextBase } = require('objection/lib/queryBuilder/QueryBuilderContextBase');
const { QueryBuilderUserContext } = require('objection/lib/queryBuilder/QueryBuilderUserContext');
const { deprecate } = require('objection/lib/utils/deprecate');
