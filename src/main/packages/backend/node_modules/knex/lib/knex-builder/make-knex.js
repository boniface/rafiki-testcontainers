...
const { Migrator } = require('knex/lib/migrations/migrate/Migrator');
const Seeder = require('knex/lib/migrations/seed/Seeder');
const FunctionHelper = require('knex/lib/knex-builder/FunctionHelper');
const QueryInterface = require('knex/lib/query/method-constants');
const merge = require('lodash/merge');
const batchInsert = require('knex/lib/execution/batch-insert');
