...
import type { ApolloConfig } from '@apollo/server/dist/cjs/externalTypes/constructor.js';
import type { BaseContext } from '@apollo/server/dist/cjs/externalTypes/context.js';
import type { GraphQLResponse } from '@apollo/server/dist/cjs/externalTypes/graphql.js';
import type { GraphQLExperimentalFormattedSubsequentIncrementalExecutionResult } from '@apollo/server/dist/cjs/externalTypes/incrementalDeliveryPolyfill.js';
import type { GraphQLRequestContext, GraphQLRequestContextDidEncounterErrors, GraphQLRequestContextDidEncounterSubsequentErrors, GraphQLRequestContextDidResolveOperation, GraphQLRequestContextDidResolveSource, GraphQLRequestContextExecutionDidStart, GraphQLRequestContextParsingDidStart, GraphQLRequestContextResponseForOperation, GraphQLRequestContextValidationDidStart, GraphQLRequestContextWillSendResponse, GraphQLRequestContextWillSendSubsequentPayload } from '@apollo/server/dist/cjs/externalTypes/requestPipeline.js';
