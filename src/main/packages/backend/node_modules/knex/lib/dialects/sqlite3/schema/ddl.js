...
const { nanonum } = require('knex/lib/util/nanoid');
const {
  copyData,
  dropOriginal,
  renameTable,
  ...
  setForeignCheck,
  executeForeignCheck,
} = require('knex/lib/dialects/sqlite3/schema/internal/sqlite-ddl-operations');
const { parseCreateTable, parseCreateIndex } = require('knex/lib/dialects/sqlite3/schema/internal/parser');
const {
  compileCreateTable,
  compileCreateIndex,
} = require('knex/lib/dialects/sqlite3/schema/internal/compiler');
const { isEqualId, includesId } = require('knex/lib/dialects/sqlite3/schema/internal/utils');
