...
const { request_overrider: debug } = require('nock/lib/debug')
...
const Socket = require('nock/lib/socket')
const { playbackInterceptor } = require('nock/lib/playback_interceptor')
