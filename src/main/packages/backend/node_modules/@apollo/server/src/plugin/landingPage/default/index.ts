...
import type { ImplicitlyInstallablePlugin } from '@apollo/server/src/ApolloServer.js';
import type {
  ApolloServerPluginLandingPageLocalDefaultOptions,
  ApolloServerPluginLandingPageProductionDefaultOptions,
  LandingPageConfig,
} from '@apollo/server/src/plugin/landingPage/default/types.js';
import {
  getEmbeddedExplorerHTML,
  getEmbeddedSandboxHTML,
} from '@apollo/server/src/plugin/landingPage/default/getEmbeddedHTML.js';
