...
} from 'graphql/type/introspection.mjs'; // Validate GraphQL schema.

export { validateSchema, assertValidSchema } from 'graphql/type/validate.mjs'; // Upholds the spec rules about naming.

export { assertName, assertEnumValueName } from 'graphql/type/assertName.mjs';
