...
const resolvable_js_1 = __importDefault(require("@apollo/server/dist/cjs/utils/resolvable.js"));
const graphql_1 = require("graphql");
const loglevel_1 = __importDefault(require("loglevel"));
const negotiator_1 = __importDefault(require("negotiator"));
const cachePolicy_js_1 = require("@apollo/server/dist/cjs/cachePolicy.js");
const determineApolloConfig_js_1 = require("@apollo/server/dist/cjs/determineApolloConfig.js");
const errorNormalize_js_1 = require("@apollo/server/dist/cjs/errorNormalize.js");
const index_js_1 = require("@apollo/server/errors");
const httpBatching_js_1 = require("@apollo/server/dist/cjs/httpBatching.js");
const internalPlugin_js_1 = require("@apollo/server/dist/cjs/internalPlugin.js");
const preventCsrf_js_1 = require("@apollo/server/dist/cjs/preventCsrf.js");
const requestPipeline_js_1 = require("@apollo/server/dist/cjs/requestPipeline.js");
const runHttpQuery_js_1 = require("@apollo/server/dist/cjs/runHttpQuery.js");
const HeaderMap_js_1 = require("@apollo/server/dist/cjs/utils/HeaderMap.js");
const UnreachableCaseError_js_1 = require("@apollo/server/dist/cjs/utils/UnreachableCaseError.js");
const computeCoreSchemaHash_js_1 = require("@apollo/server/dist/cjs/utils/computeCoreSchemaHash.js");
const isDefined_js_1 = require("@apollo/server/dist/cjs/utils/isDefined.js");
const schemaManager_js_1 = require("@apollo/server/dist/cjs/utils/schemaManager.js");
    ...
    async addDefaultPlugins() {
        ...
        }
        {
            if (!alreadyHavePluginWithInternalId('CacheControl')) {
                const { ApolloServerPluginCacheControl } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/cacheControl')));
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && apolloConfig.key) {
                if (apolloConfig.graphRef) {
                    const { ApolloServerPluginUsageReporting } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/usageReporting')));
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && enabledViaEnvVar) {
                if (apolloConfig.key) {
                    const { ApolloServerPluginSchemaReporting } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/schemaReporting')));
        ...
        }
        {
            ...
            if (!alreadyHavePlugin) {
                const { ApolloServerPluginInlineTrace } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/inlineTrace')));
        ...
        if (!alreadyHavePlugin) {
            const { ApolloServerPluginLandingPageLocalDefault, ApolloServerPluginLandingPageProductionDefault, } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/landingPage/default')));
            const plugin = isDev
        ...
        }
        {
            ...
            if (hideSchemaDetailsFromClientErrors && !alreadyHavePlugin) {
                const { ApolloServerPluginDisableSuggestions } = await Promise.resolve().then(() => __importStar(require('@apollo/server/dist/cjs/plugin/disableSuggestions')));
