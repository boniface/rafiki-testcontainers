...
const { clone } = require('objection/lib/model/modelClone');
const { bindKnex } = require('objection/lib/model/modelBindKnex');
const { validate } = require('objection/lib/model/modelValidate');
const { isMsSql } = require('objection/lib/utils/knexUtils');
const { visitModels } = require('objection/lib/model/modelVisitor');
const { hasId, getSetId } = require('objection/lib/model/modelId');
const { map: promiseMap } = require('objection/lib/utils/promiseUtils');
const { toJson, toDatabaseJson } = require('objection/lib/model/modelToJson');
const { values, propKey, hasProps } = require('objection/lib/model/modelValues');
const { defineNonEnumerableProperty } = require('objection/lib/model/modelUtils');
const { parseRelationsIntoModelInstances } = require('objection/lib/model/modelParseRelations');
const { fetchTableMetadata, tableMetadata } = require('objection/lib/model/modelTableMetadata');
const { asArray, isFunction, isString, asSingle } = require('objection/lib/utils/objectUtils');
const { setJson, setFast, setRelated, appendRelated, setDatabaseJson } = require('objection/lib/model/modelSet');
const {
  getJsonAttributes,
  parseJsonAttributes,
  formatJsonAttributes,
} = require('objection/lib/model/modelJsonAttributes');
const { columnNameToPropertyName, propertyNameToColumnName } = require('objection/lib/model/modelColPropMap');
...
const { AjvValidator } = require('objection/lib/model/AjvValidator');
const { QueryBuilder } = require('objection/lib/queryBuilder/QueryBuilder');
...
const { ModifierNotFoundError } = require('objection/lib/model/ModifierNotFoundError');
const { RelationProperty } = require('objection/lib/relations/RelationProperty');
const { RelationOwner } = require('objection/lib/relations/RelationOwner');
...
const { InstanceFindOperation } = require('objection/lib/queryBuilder/operations/InstanceFindOperation');
const { InstanceInsertOperation } = require('objection/lib/queryBuilder/operations/InstanceInsertOperation');
const { InstanceUpdateOperation } = require('objection/lib/queryBuilder/operations/InstanceUpdateOperation');
const { InstanceDeleteOperation } = require('objection/lib/queryBuilder/operations/InstanceDeleteOperation');
